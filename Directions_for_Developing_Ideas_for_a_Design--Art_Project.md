...
schaut arbeiten von anderen an. auch: bands spielen zuerst lieder nach. es geht darum ähnlichkeiten zu finden und diese weiter zu entwickeln. ausserdem ist es gut eine bereits bearbeitete nicht geistlos zu imitieren.
...
nimm eine annahme und invertiere sie. zB "navigationssystem sind dafür da jemanden möglichst schnell von punkt A zu punkt B zu bringen. inversion: was wäre wenn navigationssysteme dafür da wären jemanden möglichst langsam ( möglichst umwegig ) von A nach B zu bringen."

### thinking with hands

do, make, build, scribble, sketch.

### physical exercise

showering, walking, jogging, cycling.

### keep sketch book by your bed

habe immer ein skizzen buch ( digital / papier ) auf dem nachtisch. oft kommen 

### sprints

arbeite an einer idee, eine kurze bestimmte zeit. diskutiert sie dann.

### civilised conversation

als vorgehen auch als *brainstorming* bekannt. redet mit leuten. es kommt auf die gute atmosphäre an. es gibt keine schlechten ideen, nur solche die weiterverfolgt werden und andere die nicht weiterverfolgt werden. an materialien ist natürlich alles erlaubt. häufig wird neben dem reden geskribbelt.
...
aus vergleichen neue ideen. ein mögliches sprachmuster hierzu ist *wie … nur für … .* ( beispiel: *wie **facebook** nur für **tiere**.* )

### matrix

ideenfindung in dem kreuzen von eigenschaften. bsp aus dem vortrag ›graham harman: Art and Paradox‹:
